public class Elephant {
    ...
    /**
     * This class the animal object Elephant
    ...
    public Elephant(String name, int chipnummer, String fressverhalten, String lebensraum, boolean bedroht, int groesse) {
        this.name = name;
    ...
    /**
     * This method provides a way to get a summary of a Elephant object's attributes in a human-readable format.

     * The string returned by this method consists of several concatenated parts, including the lion's name, chip number
     and so on.

     * This code defines a toString() method for the Elephant class. When called on an instance of the Elephant class,
    ...
    public String toString() {
        return "This elephant has the name: " + name + " and the number: " + chipnummer +
                " " + name + " lives in the " + lebensraum + " and eats " + fressverhalten +
                ". \nThe elephant is the largest land creature and " + name + " measures " + groesse +
                "m. Is the elephant threatened? " + bedroht;
    }
